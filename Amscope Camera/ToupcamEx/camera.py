...
class ToupCamCamera(object):
    ...
    def get_camera(self, cid=None):
        #func1 = lib.Toupcam_EnumV2
        #func1.restype = ctypes.c_uint
        #func1.argtypes = [ctypes.POINTER(ctypes.c_uint)]
        #data = ctypes.c_uint()
        #num_cams = func1(ctypes.byref(data))
